...
test_that(".create_list_with_template works", {
    ...
    l <- .create_list_with_template(df_reaction = df_reaction,
        template = template, reaction = reaction)
    expect_equal(l$reaction_name, "")
    expect_equal(l$reaction_formula, "H2O + CerP(16:0(3OH,4OH,15Me)/18:0) = Pi + Cer(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(l$reaction_isReversible, "")
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "H2O + CerP(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(l$reaction_product, "Pi + Cer(16:0(3OH,4OH,15Me)/18:0)")
    ...
    l <- .create_list_with_template(df_reaction = df_reaction, 
        template = template, reaction = reaction)
    expect_equal(l$reaction_name, "")
    expect_equal(l$reaction_formula, "Cer(16:0(3OH,4OH,15Me)/18:0) + ATP = ADP + CerP(16:0(3OH,4OH,15Me)/18:0) + H+")
    expect_equal(l$reaction_isReversible, "")
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "Cer(16:0(3OH,4OH,15Me)/18:0) + ATP")
    expect_equal(l$reaction_product, "ADP + CerP(16:0(3OH,4OH,15Me)/18:0) + H+")
    ...
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "Cer(16:0(3OH,4OH,15Me)/18:0) + UDP-Glucose")
    expect_equal(l$reaction_product, "GlcCer(16:0(3OH,4OH,15Me)/18:0) + H+ + UDP")
    ...
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "PC + Cer(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(l$reaction_product, "DG + SM(16:0(3OH,4OH,15Me)/18:0)")
    ...
    expect_equal(l$reaction_product, "2 Fe3+-cytochrome b5 + Cer(d16:1(4E)(3OH,4OH)(15Me)/12:0) + 2 H2O")
    ...
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "PC + Cer(16:1(3OH,4OH,15Me)/12:0)")
    expect_equal(l$reaction_product, "DG + SM(16:1(3OH,4OH,15Me)/12:0)")  
    ...
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "SM(16:1(3OH,4OH,15Me)/12:0) + H2O")
    expect_equal(l$reaction_product, "Cer(16:1(3OH,4OH,15Me)/12:0) + H+ + Phosphocholine")        
    ...
    expect_equal(l$reaction_name, "")
    expect_equal(l$reaction_formula, 
        "CoA(12:0) + SPH(d16:0(1OH,3OH)(15Me)) = Cer(16:1(3OH,4OH,15Me)/12:0) + CoA + H+")
    expect_equal(l$reaction_isReversible, "")
    expect_equal(l$reaction_geneAssociation, "")
    expect_equal(l$reaction_pathway, "")
    expect_equal(l$reaction_substrate, "CoA(12:0) + SPH(d16:0(1OH,3OH)(15Me))")
    expect_equal(l$reaction_product, "Cer(16:1(3OH,4OH,15Me)/12:0) + CoA + H+")
