...
test_that(".create_reaction works", {
    ...
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "DHAP(18:0) + FAO(16:0) = DHAP(O-16:0) + FA(18:0) + H+")
    reaction_l <- .create_reaction(substrates = list(AcylDHAP = acyldhap, FAO = fao), 
    ...
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "DHAP(O-18:0) + H+ + NADPH = PA(O-18:0/0:0) + NADP+")
    reaction_l <- .create_reaction(substrates = list(AlkylDHAP = alkyldhap), 
    ...
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "CDP-DG(12:0(11Me)/14:0) + Glycerol-3-P = PGP(12:0(11Me)/14:0) + CMP + H+")
    reaction_l <- .create_reaction(substrates = list(CDPDG = cdpdg), 
    ...
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "CDP-DG(12:0(11Me)/14:0) + myo-Inositol = PI(12:0(11Me)/14:0) + CMP + H+") 
    reaction_l <- .create_reaction(substrates = list(CDPDG = cdpdg), 
    ...
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + ATP = ADP + CerP(16:0(3OH,4OH,15Me)/18:0) + H+")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:17930")
    expect_equal(reaction_l[[1]]$CerP, "CerP(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + ATP => ADP + CerP(16:0(3OH,4OH,15Me)/18:0) + H+")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:17931")
    expect_equal(reaction_l[[1]]$CerP, "CerP(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + ATP <= ADP + CerP(16:0(3OH,4OH,15Me)/18:0) + H+")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:17932")
    expect_equal(reaction_l[[1]]$CerP, "CerP(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + ATP <=> ADP + CerP(16:0(3OH,4OH,15Me)/18:0) + H+")
    ...
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:12089")
    expect_equal(reaction_l[[1]]$GlcCer, "GlcCer(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + UDP-Glucose => GlcCer(16:0(3OH,4OH,15Me)/18:0) + H+ + UDP")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:12090")
    expect_equal(reaction_l[[1]]$GlcCer, "GlcCer(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + UDP-Glucose <= GlcCer(16:0(3OH,4OH,15Me)/18:0) + H+ + UDP")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:12091")
    expect_equal(reaction_l[[1]]$GlcCer, "GlcCer(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "Cer(16:0(3OH,4OH,15Me)/18:0) + UDP-Glucose <=> GlcCer(16:0(3OH,4OH,15Me)/18:0) + H+ + UDP")
    ...
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:18766")
    expect_equal(reaction_l[[1]]$SM, "SM(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula,
        "PC + Cer(16:0(3OH,4OH,15Me)/18:0) => DG + SM(16:0(3OH,4OH,15Me)/18:0)")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:18767")
    expect_equal(reaction_l[[1]]$SM, "SM(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula,
        "PC + Cer(16:0(3OH,4OH,15Me)/18:0) <= DG + SM(16:0(3OH,4OH,15Me)/18:0)")
    reaction_l <- .create_reaction(substrates = list(Cer = cer), 
        template = NULL, reaction =  "RHEA:18768")
    expect_equal(reaction_l[[1]]$SM, "SM(16:0(3OH,4OH,15Me)/18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula,
        "PC + Cer(16:0(3OH,4OH,15Me)/18:0) <=> DG + SM(16:0(3OH,4OH,15Me)/18:0)")
    ...
    reaction_l <- .create_reaction(substrates = list(DhCer = dhcer),
        template = NULL, reaction =  "RHEA:44621")
    expect_equal(reaction_l[[1]]$DhSM, "SM(d16:0(3OH,4OH,15Me)/12:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC + Cer(d16:0(3OH,4OH,15Me)/12:0) => DG + SM(d16:0(3OH,4OH,15Me)/12:0)")
    reaction_l <- .create_reaction(substrates = list(DhCer = dhcer),
        template = NULL, reaction =  "RHEA:44622")
    expect_equal(reaction_l[[1]]$DhSM, "SM(d16:0(3OH,4OH,15Me)/12:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC + Cer(d16:0(3OH,4OH,15Me)/12:0) <= DG + SM(d16:0(3OH,4OH,15Me)/12:0)")
    reaction_l <- .create_reaction(substrates = list(DhCer = dhcer),
        template = NULL, reaction =  "RHEA:44623")
    expect_equal(reaction_l[[1]]$DhSM, "SM(d16:0(3OH,4OH,15Me)/12:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC + Cer(d16:0(3OH,4OH,15Me)/12:0) <=> DG + SM(d16:0(3OH,4OH,15Me)/12:0)")
    ...
    reaction_l <- .create_reaction(substrates = list(LNAPE = lnape), 
        template = NULL, reaction =  "RHEA:45421")
    expect_equal(reaction_l[[1]]$GPNAE, "GPNAE(0:0)")
    expect_equal(reaction_l[[1]]$FA, "FA(14:0)")
    expect_equal(reaction_l[[2]]$reaction_formula,
        "H2O + NAPE(14:0/0:0/0:0) => FA(14:0) + H+ + GPNAE(0:0)") 
    reaction_l <- .create_reaction(substrates = list(LNAPE = lnape), 
        template = NULL, reaction =  "RHEA:45422")
    expect_equal(reaction_l[[1]]$GPNAE, "GPNAE(0:0)")
    expect_equal(reaction_l[[1]]$FA, "FA(14:0)")
    expect_equal(reaction_l[[2]]$reaction_formula,
        "H2O + NAPE(14:0/0:0/0:0) <= FA(14:0) + H+ + GPNAE(0:0)") 
    reaction_l <- .create_reaction(substrates = list(LNAPE = lnape), 
        template = NULL, reaction =  "RHEA:45423")
    expect_equal(reaction_l[[1]]$GPNAE, "GPNAE(0:0)")
    expect_equal(reaction_l[[1]]$FA, "FA(14:0)")
    expect_equal(reaction_l[[2]]$reaction_formula,
        "H2O + NAPE(14:0/0:0/0:0) <=> FA(14:0) + H+ + GPNAE(0:0)") 
    ...
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:17505")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) = FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:39995")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) = FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:17506")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) => FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:39996")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) => FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:17507")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) <= FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:39997")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) <= FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:17508")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) <=> FA(18:0) + Ethanolamine")
    reaction_l <- .create_reaction(substrates = list(NAE = nae), 
        template = NULL, reaction =  "RHEA:39998")
    expect_equal(reaction_l[[1]]$FA, "FA(18:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + NAE(18:0) <=> FA(18:0) + Ethanolamine")
    ...
    reaction_l <- .create_reaction(substrates = list(PE = pe), 
        template = NULL, reaction = "RHEA:78951")
    expect_equal(reaction_l[[1]]$DG, "DG(14:0/16:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + PE(14:0/16:0) = P-Ethanolamine + DG(14:0/16:0/0:0) + H+")
    reaction_l <- .create_reaction(substrates = list(PE = pe), 
        template = NULL, reaction = "RHEA:78952")
    expect_equal(reaction_l[[1]]$DG, "DG(14:0/16:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + PE(14:0/16:0) => P-Ethanolamine + DG(14:0/16:0/0:0) + H+")
    reaction_l <- .create_reaction(substrates = list(PE = pe), 
        template = NULL, reaction = "RHEA:78953")
    expect_equal(reaction_l[[1]]$DG, "DG(14:0/16:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + PE(14:0/16:0) <= P-Ethanolamine + DG(14:0/16:0/0:0) + H+")
    reaction_l <- .create_reaction(substrates = list(PE = pe), 
        template = NULL, reaction = "RHEA:78954")
    expect_equal(reaction_l[[1]]$DG, "DG(14:0/16:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + PE(14:0/16:0) <=> P-Ethanolamine + DG(14:0/16:0/0:0) + H+")
    ...
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45188")
    ...
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45189")
    expect_equal(reaction_l[[1]]$NAPE, "NAPE(14:0/16:0/18:0)")
    expect_equal(reaction_l[[1]]$sn2LPC, "PC(0:0/20:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC(18:0/20:0) + PE(14:0/16:0) => PC(0:0/20:0) + H+ + NAPE(14:0/16:0/18:0)")
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45190")
    expect_equal(reaction_l[[1]]$NAPE, "NAPE(14:0/16:0/18:0)")
    expect_equal(reaction_l[[1]]$sn2LPC, "PC(0:0/20:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC(18:0/20:0) + PE(14:0/16:0) <= PC(0:0/20:0) + H+ + NAPE(14:0/16:0/18:0)")
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45191")
    expect_equal(reaction_l[[1]]$NAPE, "NAPE(14:0/16:0/18:0)")
    expect_equal(reaction_l[[1]]$sn2LPC, "PC(0:0/20:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC(18:0/20:0) + PE(14:0/16:0) <=> PC(0:0/20:0) + H+ + NAPE(14:0/16:0/18:0)")
    ...
    pc <- "PC(18:0/20:0)"
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45192")
    ...
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45193")
    expect_equal(reaction_l[[1]]$NAPE, "NAPE(14:0/16:0/20:0)")
    expect_equal(reaction_l[[1]]$sn1LPC, "PC(18:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC(18:0/20:0) + PE(14:0/16:0) => PC(18:0/0:0) + H+ + NAPE(14:0/16:0/20:0)")
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45194")
    expect_equal(reaction_l[[1]]$NAPE, "NAPE(14:0/16:0/20:0)")
    expect_equal(reaction_l[[1]]$sn1LPC, "PC(18:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC(18:0/20:0) + PE(14:0/16:0) <= PC(18:0/0:0) + H+ + NAPE(14:0/16:0/20:0)")
    reaction_l <- .create_reaction(substrates = list(PE = pe, PC = pc), 
        template = NULL, reaction = "RHEA:45195")
    expect_equal(reaction_l[[1]]$NAPE, "NAPE(14:0/16:0/20:0)")
    expect_equal(reaction_l[[1]]$sn1LPC, "PC(18:0/0:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "PC(18:0/20:0) + PE(14:0/16:0) <=> PC(18:0/0:0) + H+ + NAPE(14:0/16:0/20:0)")
    ...
    reaction_l <- .create_reaction(substrates = list(SM = sm), 
        template = NULL, reaction = "RHEA:45644")
    ...
    reaction_l <- .create_reaction(substrates = list(SM = sm), 
        template = NULL, reaction = "RHEA:45645")
    expect_equal(reaction_l[[1]]$Cer, "Cer(16:0(3OH,4OH,15Me)/12:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + SM(16:0(3OH,4OH,15Me)/12:0) => H+ + Cer(16:0(3OH,4OH,15Me)/12:0) + Phosphocholine")
    reaction_l <- .create_reaction(substrates = list(SM = sm), 
        template = NULL, reaction = "RHEA:45646")
    expect_equal(reaction_l[[1]]$Cer, "Cer(16:0(3OH,4OH,15Me)/12:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + SM(16:0(3OH,4OH,15Me)/12:0) <= H+ + Cer(16:0(3OH,4OH,15Me)/12:0) + Phosphocholine")
    reaction_l <- .create_reaction(substrates = list(SM = sm), 
        template = NULL, reaction = "RHEA:45647")
    expect_equal(reaction_l[[1]]$Cer, "Cer(16:0(3OH,4OH,15Me)/12:0)")
    expect_equal(reaction_l[[2]]$reaction_formula, 
        "H2O + SM(16:0(3OH,4OH,15Me)/12:0) <=> H+ + Cer(16:0(3OH,4OH,15Me)/12:0) + Phosphocholine")
...
test_that("create_reactions works.", {
    ...
    reactions <- data.frame(order = reactions[, 1], 
        reaction_name = reactions[, 2], RHEA = reactions[, 3],
