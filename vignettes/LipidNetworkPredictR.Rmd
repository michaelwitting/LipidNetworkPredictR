...
results <- .create_reaction(
    substrates = list(LPA = LPA, CoA = CoA_GPGL),
...
results <- .create_reaction(substrates = list(PA = PA),
    template = template, reaction = "pa_to_dg")
...
```{r, message=FALSE, warning=FALSE}
results <-  .create_reaction(substrates = list(DG = DG),
    template = template, reaction = "dg_to_sn2mg")
...
results <-  .create_reaction(substrates = list(sn1MG = sn1MG),
    template = template, reaction = "sn1mg_to_fa")
...
```{r, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(substrates = list(sn2MG = sn2MG),
    template = template, reaction = "sn2mg_to_fa")
...
```{r, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(
    substrates = list(sn1MG = sn1MG, CoA = CoA_GPGL),
...
```{r, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(
    substrates = list(sn2MG = sn2MG, CoA = CoA_GPGL), 
...
results <-  .create_reaction(
    substrates = list(DG = DG, CoA = CoA_GPGL), 
...
results <-  .create_reaction(substrates = list(TG = TG),
    template = template, reaction = "tg_to_dg")
...
results <-  .create_reaction(substrates = list(PS = PS),
    template = template, reaction = "ps_to_pe")
...
results <-  .create_reaction(
    substrates = list(sn1LPC = sn1LPC, CoA = CoA_GPGL),
...
results <-  .create_reaction(substrates = list(PE = PE),
    template = template, reaction = "pe_to_sn1lpe")
...
results <-  .create_reaction(
    substrates = list(sn1LPE = sn1LPE, CoA = CoA_GPGL),
...
results <-  .create_reaction(substrates = list(PA = PA),
    template = template, reaction = "pa_to_cdpdg")
...
results <-  .create_reaction(substrates = list(PGP = PGP),
    template = template, reaction = "pgp_to_pg")
...
```{r coa_to_acdhap, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(substrates = list(CoA = CoA_GPGL),
                             template = template,
                             reaction = "coa_to_acdhap")
...
results <-  .create_reaction(substrates = list(ACDHAP = ACDHAP,
                                               FATOH = FATOH),
                             template = template,
                             reaction = "RHEA:36171")
...
results <-  .create_reaction(substrates = list(LPAO = LPAO, CoA = CoA_GPGL), 
    template = template, reaction = "", constraints = c("", "OH"),
    negate = c(FALSE, TRUE)) ##not implemented, was RHEA:19709, but also LPA to PA
...
results <-  .create_reaction(substrates = list(PAO = PAO),
    template = template, reaction = "pao_to_dgo") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(DGO = DGO),
    template = template, reaction = "RHEA:36187") ## ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(PEO = PEO),
    template = template, reaction = "peo_to_pep") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(DGO = DGO),
    template = template, reaction = "RHEA:36179") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(PEO = PEO),
    template = template, reaction = "peo_to_lpeo") ## not run due to missing precursors
...
```{r lpeo_to_peo_template, message=FALSE, warning=FALSE, eval=F}
## template for reaction -------------------------------------------------------
template <- list(
...
results <-  .create_reaction(substrates = list(LPEO = LPEO, CoA = CoA_GPGL), 
    template = template, reaction = "lpeo_to_peo") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(PEP = PEP),
    template = template, reaction = "pep_to_lpep") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(LPEP = LPEP,  CoA = CoA_GPGL), 
    template = template, reaction = "lpep_to_pep") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(PCO = PCO),
    template = template, reaction = "pco_to_lpco") ## not run due to missing precursors
...
results <-  .create_reaction(substrates = list(CoA = CoA_SPH),
...
results <-  .create_reaction(substrates = list(CER = CER),
    template = template, reaction = "cer_to_sm")
...
results <-  .create_reaction(substrates = list(PEO = PEO, PC = PC), 
    template = template, reaction = "peo_to_napeo_sn1") ## not run, since precursors are not available
...
results <-  .create_reaction(substrates = list(PEP = PEP, PC = PC), 
    template = template, reaction = "pep_to_napep_sn1") ## not run, since precursors are not available
...
results <-  .create_reaction(substrates = list(PEO = PEO, PC = PC), 
    template = template, reaction = "peo_to_napeo_sn2") ## not run, since precursors are not available
...
results <-  .create_reaction(substrates = list(PEP = PEP, PC = PC),
    template = template, reaction = "pep_to_napep_sn2") ## not run, since precursors are not available
...
results <-  .create_reaction(substrates = list(NAPEO = NAPEO),
    template = template, reaction = "napeo_to_nae") ## not run, since precursors are not available
