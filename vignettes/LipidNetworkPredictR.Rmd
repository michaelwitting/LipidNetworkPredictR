...
>>>>>>> e2d252c5510eae27541a4c7ff5503dd73fc86644
...
results <-  .create_reaction(substrates = list(PG = PG,
                                               CDPDG = CDPDG),
                             template = template,
                             reaction = "pg_to_cl",
...
results <-  .create_reaction(substrates = list(LPAO = LPAO,
                                               CoA = CoA_GPGL), 
                             template = template,
                             reaction = "RHEA:19709",
                             constraints = c("", "OH"),
...
# biosynthesis of PEO ----------------------------------------------------------
results <-  .create_reaction(substrates = list(LPEO = LPEO,
                                               CoA = CoA_GPGL), 
                             template = template,
...
results <-  .create_reaction(substrates = list(LPEP = LPEP,
                                               CoA = CoA_GPGL), 
                             template = template,
                             reaction = "lpep_to_pep")
