...
results <- create_reaction(substrates = list(FA = FA_GPGL), 
    template = template, reaction = "fa_to_coa")
...
```{r, message=FALSE, warning=FALSE}
## convert fatty acids to acyl CoA --------------------------------------------
results <- create_reaction(substrates = list(FA = FA_SPH), template = template,
    reaction = "fa_to_coa")
results[[2]][1:10, "ReactionFormula"]
...
## biosynthesis of LPA --------------------------------------------------------
results <- create_reaction(substrates = list(CoA = CoA_GPGL), template = template,
    reaction = "coa_to_lpa")
results[[2]][1:10, "ReactionFormula"]
...
## biosynthesis of PA ---------------------------------------------------------
results <- create_reaction(substrates = list(LPA = LPA, CoA = CoA_GPGL), 
    template = template, reaction = "lpa_to_pa")
results[[2]][1:10, "ReactionFormula"]
...
```{r, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(sn2MG = sn2MG), template = template,
...
```{r, message=FALSE, warning=FALSE, eval=FALSE}
results <-  create_reaction(substrates = list(sn1MG = sn1MG), template = template,
...
```{r, message=FALSE, warning=FALSE, eval=FALSE}
results <-  create_reaction(substrates = list(sn1MG = sn1MG, CoA = CoA_GPGL), 
...
```{r, message=FALSE, warning=FALSE, eval=FALSE}
results <-  create_reaction(substrates = list(sn2MG = sn2MG, CoA = CoA_GPGL), 
...
results <-  create_reaction(substrates = list(DG = DG, CoA = CoA_GPGL), 
    template = template, reaction = "dg_to_tg")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(sn1LPC = sn1LPC), 
    template = template, reaction = "sn1lpc_to_fa")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(sn2LPC = sn2LPC), 
    template = template, reaction = "sn2lpc_to_fa")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(sn1LPC = sn1LPC, CoA = CoA_GPGL),
    template = template, reaction = "sn1lpc_to_pc", 
...
results <-  create_reaction(substrates = list(sn1LPE = sn1LPE), 
    template = template, reaction = "sn1lpe_to_fa")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(sn1LPE = sn1LPE, CoA = CoA_GPGL), 
    template = template, reaction = "sn1lpe_to_pe", constraints = c("", "OH"),
    negate = c(FALSE, TRUE))
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(CoA = CoA_GPGL), 
    template = template, reaction = "coa_to_fatoh", 
...
results <-  create_reaction(substrates = list(ACDHAP = ACDHAP, FATOH = FATOH), 
    template = template, reaction = "acdhap_to_alkyldhap")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(ALKYLDHAP = ALKYLDHAP),
    template = template, reaction = "alkyldhap_to_lpao")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(LPAO = LPAO, CoA = CoA_GPGL), 
    template = template, reaction = "lpao_to_pao",
    constraints = c("", "OH"), negate = c(FALSE, TRUE))
results[[2]][1:10, "ReactionFormula"]
...
# biosynthesis of PEO ----------------------------------------------------------
results <-  create_reaction(substrates = list(LPEO = LPEO, CoA = CoA_GPGL), 
...
results <-  create_reaction(substrates = list(LPEP = LPEP, CoA = CoA_GPGL), 
...
results <-  create_reaction(substrates = list(CoA = CoA_SPH), template = template,
...
results <-  create_reaction(substrates = list(DHCER = DHCER), 
    template = template, reaction = "dhcer_to_dhsm")
results[[2]][1:10, "ReactionFormula"]
...
results <-  create_reaction(substrates = list(C1P = C1P), template = template,
    reaction = "c1p_to_cer")
results[[2]][1:10, "ReactionFormula"]
