...
fatty_acid_gl_gp_df <- read.table(f,
                                  sep = "\t",
                                  header = TRUE, 
                                  comment.char = "",
...
fatty_acid_sph_df <- read.table(f, sep = "\t",
                                header = TRUE,
                                comment.char = "",
                                stringsAsFactors = FALSE) |>
    data.frame()
...
results <- create_reaction(substrates = list(LPA = LPA,
                                             CoA = CoA_GPGL), 
                           template = template,
                           reaction = "lpa_to_pa")
