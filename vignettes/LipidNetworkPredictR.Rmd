...
```{r dgo_to_peo, message=FALSE, warning=FALSE, eval=F}
...
```{r peo_to_pep, message=FALSE, warning=FALSE, eval=F}
...
```{r dgo_to_pco, message=FALSE, warning=FALSE, eval=F}
results <-  .create_reaction(substrates = list(DGO = DGO),
...
```{r peo_to_lpeo, message=FALSE, warning=FALSE, eval=F}
results <-  .create_reaction(substrates = list(PEO = PEO),
...
```{r lpeo_to_peo, message=FALSE, warning=FALSE, eval=F}
# biosynthesis of PEO ----------------------------------------------------------
...
```{r pep_to_lpep, message=FALSE, warning=FALSE, eval=F}
...
```{r lpep_to_pep, message=FALSE, warning=FALSE, eval=F}
...
```{r pco_to_lpco, message=FALSE, warning=FALSE, eval=F}
