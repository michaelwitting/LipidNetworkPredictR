...
```{r fa_to_CoA_GPGL, message=FALSE, warning=FALSE}
...
results[[2]][["reaction_formula"]][1:10]

## add new lipids to lipid vector
lipid_abbrev <- c(lipid_abbrev, results[[1]][["AcylCoA"]])
...
lipid_reactions <- c(lipid_reactions, results[[2]][["reaction_formula"]])
...
## add new lipids to lipid vector
lipid_abbrev <- c(lipid_abbrev, results[[1]][["sn1LPA"]])
...
```{r lpa_tp_pa_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
...
```{r dg_to_sn1mg_template, message=FALSE, warning=FALSE}
# template for reaction --------------------------------------------------------
...
```{r dg_to_sn1mg, message=FALSE, warning=FALSE}
results <- .create_reaction(substrates = list(DG = DG), template = template,
    reaction = "RHEA:44712")
results[[2]][["reaction_formula"]][1:10]
...
```{r dg_to_sn2mg, message=FALSE, warning=FALSE}
results <-  .create_reaction(substrates = list(DG = DG), template = template,
    reaction = "RHEA:33275")
results[[2]][["reaction_formula"]][1:10]
...
results <-  .create_reaction(
    substrates = list(sn1LPE = sn1LPE, AcylCoA = CoA_GPGL), 
...
```{r coa_to_FAO_template, message=FALSE, warning=FALSE, eval=FALSE}
## template for reaction -------------------------------------------------------
...
```{r coa_to_FAO, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r coa_to_acyldhap_template, message=FALSE, warning=FALSE, eval=FALSE}
## template for reaction -------------------------------------------------------
...
```{r coa_to_acyldhap, message=FALSE, warning=FALSE, eval=FALSE}
results <-  .create_reaction(substrates = list(AcylCoA = CoA_GPGL), 
    template = template, reaction = "RHEA:17657")
results[[2]][["reaction_formula"]][1:10]

## add new lipids to lipid vector
lipid_abbrev <- c(lipid_abbrev,  results[[1]][["AcylDHAP"]])
...
results <-  .create_reaction(substrates = list(sn1LPEP = LPEP, AcylCoA = CoA_GPGL), 
...
## add new lipids to lipid vector
lipid_abbrev <- c(lipid_abbrev, results[[1]][["sn1LPCO"]])
...
results <-  .create_reaction(substrates = list(DhCER = DhCER), 
    template = template, reaction = "RRHEA:44620")
results[[2]][["reaction_formula"]][1:10]
...
template <- list(reaction_name = "Dihydroceramide dehydrogenase",
    reaction_formula = "M_DhCer + 2 M_Fe2+-cytochrome_b5 + 2 M_H+ + M_O2 = 2 M_Fe3+-cytochrome_b5 + M_Cer + 2 M_H2O",
    reaction_RHEA = "RHEA:46544"
    reaction_isReversible = "FALSE",
...
## add new lipids to lipid vector
lipid_abbrev <- c(lipid_abbrev, results[[1]][["CerP"]])
...
template <- list(reaction_name = "Ceramide 1-phosphate hydrolase",
    ...
    reaction_RHEA = "RHEA:33743",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "Biosynthesis and degradation of sphingolipids")
```

```{r cerp_to_cer, message=FALSE, warning=FALSE, eval=FALSE}
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_PE-P + M_PC = M_NAPEP + M_2-LPC",
    reaction_RHEA = "RHEA:63596",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
```
...
results <-  .create_reaction(substrates = list(PEP = PEP, PC = PC), 
    template = template, reaction = "RHEA:63596")
results[[2]][["reaction_formula"]][1:10]
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_NAPE + M_H2O <=> M_LNAPE + M_FA + M_H+",
    reaction_RHEA = "RHEA:45460",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
```
