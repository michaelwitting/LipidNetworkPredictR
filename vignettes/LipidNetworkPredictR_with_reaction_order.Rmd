...
reactions <- rbind(
    ...
    c(8, "RHEA:17929", "M_ATP + M_Cer = M_H+ + M_ADP + M_CerP"), ## ATP + Cer = H+ + ADP + CerP
    c(9, "cerp_to_cer", "M_H2O + M_CerP = M_Pi + M_Cer"), ## H2O + CerP = Pi + Cer
...
`cer_to_cerp`:
- `"RHEA:17929"`: `"M_ATP + M_Cer <=> M_H+ + M_ADP + M_CerP"`
