...
-   `CerP`: Ceramide phosphates [SP0205],
...
template <- list(reaction_name = "CoA biosynthesis",
    reaction_formula = "M_FA + M_ATP + M_CoA = M_AcylCoA + M_AMP + M_PPi",
...
results[[2]][["reaction_formula"]][1:5]
...
template <- list(reaction_name = "1,2-diacyl-sn-glycerol 3-phosphate phosphohydrolase (ER)",
    reaction_formula = "M_PA + M_H2O = M_1,2-DG + M_Pi",
...
template <- list(reaction_name = "1,2-diacyl-sn-glycerol kinase (ER)",
    reaction_formula = "M_1,2-DG + M_ATP = M_PA + M_ADP + M_H+",
...
template <- list(reaction_name = "1,2-diacyl-sn-glycerol acylhydrolase (1-acyl-MG)",
    reaction_formula = "M_1,2-DG + M_H2O = M_1-MG + M_FA + M_H+",
...
template <- list(reaction_name = "1,2-diacyl-sn-glycerol acylhydrolase (2-acyl-MG)",
    reaction_formula = "M_1,2-DG + M_H2O = M_2-MG + M_FA + M_H+",
...
template <- list(reaction_name = "1-acyl-sn-glycerol acylhydrolase",
    reaction_formula = "M_1-MG + M_H2O = M_FA + M_Glycerol + M_H+",
...
template <- list(reaction_name = "2-acyl-sn-glycerol acylhydrolase",
    reaction_formula = "M_H2O + M_2-MG = M_FA + M_Glycerol + M_H+",
...
template <- list(reaction_name = "Monoacylglycerol-acyl transferase (1-acyl-MG)",
    reaction_formula = "M_1-MG + M_AcylCoA = M_1,2-DG + M_CoA",
...
template <- list(reaction_name = "Monoacylglycerol-acyl transferase (2-acyl-MG)",
    reaction_formula = "M_2-MG + M_AcylCoA = M_1,2-DG + M_CoA",
...
template <- list(reaction_name = "1-acyl-sn-glycerol kinase",
    reaction_formula = "M_1-MG + M_ATP = M_LPA + M_ADP + M_H+",
...
template <- list(reaction_name = "diacylglycerol acyl transferase",
    reaction_formula = "M_1,2-DG + M_AcylCoA = M_TG + M_CoA",
...
template <- list(reaction_name = "Triacylglycerol acylhydrolase",
    reaction_formula = "M_TG + M_H2O = M_1,2-DG + M_FA + M_H+",
...
template <- list(reaction_name = "CDP-choline 1,2-diacyl-sn-glycerol phosphocholine transferase",
    reaction_formula = "M_1,2-DG + M_CDP-Choline = M_PC + M_CMP + M_H+",
...
template <- list(
    ...
    reaction_formula = "M_1,2-DG + M_CDP-Ethanolamine = M_PE + M_CMP + M_H+",
...
template <- list(reaction_name = "phosphatidylcholine-serine O-phosphatidyltransferase",
    reaction_formula = "M_PC_c + M_L-Serine_c = M_PS_c + M_Choline_c",
...
template <- list(
    ...
    reaction_formula = "M_PE_c + M_L-Serine_c = M_PS_c + M_Ethanolamine_c",
...
template <- list(reaction_name = "phosphatidylserine decarboxylase",
    reaction_formula = "M_PS + M_H+ = M_PE + M_CO2",
...
template <- list(reaction_name = "Phospholipase A1 (PC)",
    reaction_formula = "M_PC_c + M_H2O_c = M_2-LPC_c + M_FA_c + M_H+_c",
...
template <- list(reaction_name = "Phospholipase A2 (PC)",
    reaction_formula = "M_PC + M_H2O  = M_1-LPC + M_FA + M_H+",
...
template <- list(reaction_name = "Phospholipase D (PC)",
    reaction_formula = "M_PC + M_H2O = M_PA + M_Choline + M_H+",
...
template <- list(reaction_name = "1-acyl-sn-glycero-3-phosphocholine lipase (LPC)",
    reaction_formula = "M_1-LPC + M_H2O = M_FA + M_H+ + M_Glycerophosphocholine",
...
template <- list(reaction_name = "2-acyl-sn-glycero-3-phosphocholine lipase (LPC)",
    reaction_formula = "M_2-LPC + M_H2O = M_FA + M_H+ + M_Glycerophosphocholine",
...
template <- list(reaction_name = "Phospholipase A1 (PE)",
    reaction_formula = "M_PE + M_H2O = M_2-LPE + M_FA + M_H+",
...
template <- list(reaction_name = "Phospholipase A2 (PE)",
    reaction_formula = "M_PE + M_H2O = M_1-LPE + M_FA + M_H+",
...
template <- list(reaction_name = "Phospholipase D (PE)",
    reaction_formula = "M_PE + M_H2O <=> M_PA + M_Ethanolamine + M_H+",
    reaction_RHEA = "",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "WBGene00004040 or WBGene00017316 or WBGene00013080",
    reaction_pathway = "Remodeling and Degradation of Glycerophospholipids")
...
template <- list(reaction_name = "1-acyl-sn-glycero-3-phosphoethanolamine lipase (LPE)",
    reaction_formula = "M_1-LPE + M_H2O = M_FA + M_H+ + M_Glycerophosphoethanolamine",
...
template <- list(reaction_name = "2-acyl-sn-glycero-3-phosphoethanolamine lipase (LPE)",
    reaction_formula = "M_2-LPE + M_H2O <=> M_FA + M_H+ + M_Glycerophosphoethanolamine",
    reaction_RHEA = "",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "WBGene00010915 or WBGene00022718",
    reaction_pathway = "Remodeling and Degradation of Glycerophospholipids")
...
template <- list(
    ...
    reaction_formula = "M_1-LPE + M_AcylCoA = M_PE + M_CoA",
...
template <- list(reaction_name = "phosphatidate cytidylyltransferase",
    reaction_formula = "M_PA + M_CTP + M_H+ = M_CDP-DG + M_PPi",
...
template <- list(reaction_name = "CDP-diacylglycerol inositol transferase",
    reaction_formula = "M_CDP-DG + M_myo-Inositol = M_PI + M_CMP + M_H+",
...
template <- list(reaction_name = "CDP-diacylglycerol--glycerol-3-phosphate 3-phosphatidyltransferase",
    reaction_formula = "M_CDP-DG + M_Glycerol-3-P = M_PGP + M_CMP + M_H+",
...
template <- list(reaction_name = "Phosphatidylglycerophosphatase",
    reaction_formula = "M_PGP + M_H2O = M_PG + M_Pi",
...
template <- list(reaction_name = "Cardiolipin synthase",
    reaction_formula = "M_PG + M_CDP-DG = M_CL + M_CMP + M_H+",
...
```{r coa_to_FAO_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "Fatty acyl-CoA reductase",
    reaction_formula = "M_AcylCoA + 2 M_H+ + 2 M_NADPH = M_FAO + M_CoA + 2 M_NADP",
...
```{r coa_to_FAO, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(substrates = list(AcylCoA = CoA_GPGL),
...
template <- list(reaction_name = "Glycerone-phosphate O-acyltransferase",
    reaction_formula = "M_AcylCoA + M_Dihydroxyacetone-P = M_AcylDHAP + M_CoA",
...
template <- list(reaction_name = "Alkyldihydroxyacetonephosphate synthase",
    reaction_formula = "M_AcylDHAP + M_FAO = M_AlkylDHAP + M_FA + M_H+",
...
template <- list(reaction_name = "1-acylglycerone phosphate reductase",
    reaction_formula = "M_AlkylDHAP + M_H+ + M_NADPH = M_LPA-O + M_NADP",
...
template <- list(reaction_name = "2-O-Acyl transferase",
    reaction_formula = "M_LPA-O + M_AcylCoA = M_PA-O + M_CoA",
...
template <- list(reaction_name = "1-Alkyl-2-acyl-sn-glycero-3-phosphate phosphohydrolase",
    reaction_formula = "M_PA-O + M_H2O = M_DG-O + M_Pi",
...
template <- list(
    ...
    reaction_formula = "M_DG-O + M_CDP-Ethanolamine =  M_PE-O + M_CMP + M_H+",
...
template <- list(
    ...
    reaction_formula = "M_DG-O + M_CDP-Choline = M_PC-O + M_CMP + M_H+",
...
template <- list(reaction_name = "Phospholipase A2 (PE-O)",
    reaction_formula = "M_PE-O + M_H2O <=> M_LPE-O + M_FA + M_H+",
    reaction_RHEA = "",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "WBGene00009801 or WBGene00012319",
...
template <- list(reaction_name = "Phospholipase A2 (PE-P)",
    reaction_formula = "M_PE-P + M_H2O = M_LPE-P + M_FA + M_H+",
...
template <- list(
    ...
    reaction_formula = "M_LPE-P + M_AcylCoA = M_PE-P + M_CoA",
...
template <- list(reaction_name = "Phospholipase A2 (PC-O)",
    reaction_formula = "M_PC-O + M_H2O = M_LPC-O + M_FA + M_H+",
...
template <- list(reaction_name = "Sphinganine Acyl-CoA transferase",
    reaction_formula = "M_AcylCoA + M_Sphinganine = M_DhCer + M_CoA + M_H+",
...
results <-  .create_reaction(substrates = list(AcylCoA = CoA_SPH, SPH = "SPH(d16:0(1OH,3OH)(15Me))"),
...
template <- list(reaction_name = "Dihydrosphingomyelin synthase",
    reaction_formula = "M_PC + M_DhCer = M_1,2-DG + M_DhSM",
...
template <- list(reaction_name = "Dihydrosphingomyelin phosphodiesterase",
    reaction_formula = "M_DhSM + M_H2O = M_DhCer + M_H+ + M_Phosphocholine",
...
results <-  .create_reaction(substrates = list(DhCer = DhCer),
    template = template, reaction = "RHEA:46544")
results[[2]][["reaction_formula"]][1:5]
...
template <- list(reaction_name = "Sphingomyelin synthase",
    reaction_formula = "M_PC + M_Cer = M_1,2-DG + M_SM",
...
template <- list(reaction_name = "Sphingomyelin phosphodiesterase",
    reaction_formula = "M_H2O + M_SM = M_H+ + M_Cer + M_Phosphocholine",
    reaction_RHEA = "RHEA:45644",
    reaction_isReversible = "FALSE",
...
results <-  .create_reaction(substrates = list(SM = SM),
    template = template, reaction = "RHEA:45644")
...
```{r cer_to_cerp_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "Ceramide kinase",
    reaction_formula = "M_Cer + M_ATP = M_ADP + M_CerP + M_H+",
    reaction_RHEA = "",
    reaction_isReversible = "FALSE",
...
```{r cer_to_cerp, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(substrates = list(Cer = Cer),
...
```{r CerP_to_cer_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
...
```{r CerP_to_cer, message=FALSE, warning=FALSE, eval=TRUE}
results <-  .create_reaction(substrates = list(CerP = CerP),
    template = template, reaction = "RHEA:33743")
...
template <- list(
    ...
    reaction_formula = "M_Cer + M_UDP-Glucose = M_GlcCer + M_H+ + M_UDP",
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_PC + M_PE = M_2-LPC + M_H+ + M_NAPE",
    reaction_RHEA = "RHEA:45188",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
```
...
results <-  .create_reaction(substrates = list(PE = PE, PC = PC), 
    template = template, reaction = "RHEA:45188")
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_PE-P + M_PC = M_NAPEP + M_H+ + M_2-LPC",
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_PC + M_PE = M_1-LPC + M_H+ + M_NAPE",
    reaction_RHEA = "RHEA:45192",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
```
...
results <-  .create_reaction(substrates = list(PE = PE, PC = PC),
    template = template, reaction = "RHEA:45192")
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_PE-P + M_PC <=> M_NAPEP + M_1-LPC",
    reaction_RHEA = "",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
...
results <-  .create_reaction(substrates = list(NAPE = NAPE),
    template = template, reaction = "RHEA:33159")
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_NAPE + M_H2O <=> M_PNAE + M_1,2-DG",
    reaction_RHEA = "",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
...
results <-  .create_reaction(substrates = list(NAPE = NAPE),
    template = template, reaction = "RHEA:45460")
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_H2O + M_LNAPE = M_FA + M_H+ + M_GPNAE",
...
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
    reaction_formula = "M_H2O + M_NAE = M_FA + M_Ethanolamine",
    reaction_RHEA = "RHEA:17505",
    reaction_isReversible = "FALSE",
    reaction_geneAssociation = "",
    reaction_pathway = "")
```
...
results <-  .create_reaction(substrates = list(NAE = NAE),
    template = template, reaction = "RHEA:17505")
