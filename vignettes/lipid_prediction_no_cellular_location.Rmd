...
DG can be phosphorylated to create PA, which is the reversal of the reactoin above.
...
## add new lipids to lipid vector
## lipid_abbrev <- c(lipid_abbrev, results[[1]][["MG"]])
...
```{r, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(sn1LPC = sn1LCP), 
...
```{r, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(sn1LPC = sn1LPC, CoA_GPGL = CoA_GPGL),
...
results <-  create_reaction(substrates = list(CoA_GPGL = CoA_GPGL), 
...
## add new lipids to lipid vector
lipid_abbrev <- c(lipid_abbrev,  results[[1]][["ACDHAP"]])

## get ACDHAP for further reactions
ACDHAP <- results[[1]][["ACDHAP"]]
...
results <-  create_reaction(substrates = list(LPEP = LPEP, CoA = CoA), 
