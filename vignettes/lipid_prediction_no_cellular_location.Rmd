...
The following abbreviations are used (in alphabetical order):
 ...
 - `FA`: fatty acid,
 - `FATOH`: fatty acid alcohol,
 - `GLCCER`: glycosylceramide,
 ...
 - `SM`: sphingomyelin,
 - `sn1LPC`: sn1 lysophosphatidylcholine,
 - `sn1LPE`: sn1 lysophosphatidylethanolamine ,
 - `sn1MG`: sn1 monoglyceride,
 - `sn2LPC`: sn2 lysophosphatidylcholine,
 - `sn2LPE`: sn1 lysophosphatidylethanolamine,
 - `sn2MG`: sn2 monoglyceride
 - `SPHINGA`: sphingosine...
 - `TG`: triglyceride
...
```{r dg_to_tg, message=FALSE, warning=FALSE}
...
```{r tg_to_dg, message=FALSE, warning=FALSE}
...
```{r dg_to_pc, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(DG = DG), template = template,
    reaction = "dg_to_pc")
results[[2]][1:10, "ReactionFormula"]
...
```{r dg_to_pe, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(DG = DG), template = template,
    reaction = "dg_to_pe")
results[[2]][1:10, "ReactionFormula"]
...
```{r pc_to_ps, message=FALSE, warning=FALSE}
...
```{r pe_to_ps, message=FALSE, warning=FALSE}
...
```{r ps_to_pe, message=FALSE, warning=FALSE}
...
```{r pc_to_sn2lpc, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PC = PC), template = template,
...
```{r pc_to_sn1lpc, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PC = PC), template = template,
...
```{r pc_to_pa, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PC = PC), template = template,
    reaction = "pc_to_pa")
results[[2]][1:10, "ReactionFormula"]
...
```{r sn1lpc_to_fa, message=FALSE, warning=FALSE}
...
```{r sn2lpc_to_fa, message=FALSE, warning=FALSE}
...
```{r sn1lpc_to_pc, message=FALSE, warning=FALSE}
...
```{r pe_to_sn2lpe, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PE = PE), template = template,
...
```{r pe_to_sn1lpe, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PE = PE), template = template,
...
```{r pe_to_pa, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PE = PE), template = template,
    reaction = "pe_to_pa")
results[[2]][1:10, "ReactionFormula"]
...
```{r sn1lpe_to_fa, message=FALSE, warning=FALSE}
...
```{r sn2lpe_to_fa, message=FALSE, warning=FALSE}
...
```{r sn1lpe_to_pe, message=FALSE, warning=FALSE}
...
```{r pa_to_cdpdg, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PA = PA), template = template,
...
```{r cdpdg_to_pi, message=FALSE, warning=FALSE}
...
```{r cdpdg_to_pgp, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(CDPDG = CDPDG), template = template,
...
```{r pgp_to_pg, message=FALSE, warning=FALSE}
...
```{r pg_to_cl, message=FALSE, warning=FALSE}
...
```{r coa_to_fatoh, message=FALSE, warning=FALSE}
...
```{r coa_to_acdhap_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
...
```{r coa_to_acdhap, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(CoA = CoA_GPGL), 
...
```{r acdhap_to_alkyldhap_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
...
```{r acdhap_to_alkyldhap, message=FALSE, warning=FALSE}
...
```{r alkyldhap_to_lpao, message=FALSE, warning=FALSE}
...
```{r lpao_to_pao, message=FALSE, warning=FALSE}
...
```{r pao_to_dgo, message=FALSE, warning=FALSE}
...
```{r dgo_to_peo, message=FALSE, warning=FALSE}
...
```{r peo_to_pep, message=FALSE, warning=FALSE}
...
```{r dgo_to_pco, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(DGO = DGO), template = template,
    reaction = "dgo_to_pco")
results[[2]][1:10, "ReactionFormula"]
...
```{r peo_to_lpeo, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PEO = PEO), template = template,
...
```{r lpeo_to_peo_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
...
```{r lpeo_to_peo, message=FALSE, warning=FALSE}
# biosynthesis of PEO ----------------------------------------------------------
...
```{r pep_to_lpep, message=FALSE, warning=FALSE}
...
```{r lpep_to_pep, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r pco_to_lpco, message=FALSE, warning=FALSE}
...
```{r sphinga_to_dhcer_template, message=FALSE, warning=FALSE}
...
```{r dhcer_to_dhsm, message=FALSE, warning=FALSE}
...
```{r dhsm_to_dhcer, message=FALSE, warning=FALSE}
...
```{r dhcer_to_cer, message=FALSE, warning=FALSE}
...
```{r cer_to_sm, message=FALSE, warning=FALSE}
...
```{r sm_to_cer, message=FALSE, warning=FALSE}
...
```{r cer_to_c1p, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(CER = CER), template = template,
    reaction = "cer_to_c1p")
results[[2]][1:10, "ReactionFormula"]
...
```{r c1p_to_cer, message=FALSE, warning=FALSE}
...
```{r cer_to_glccer, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(CER = CER), template = template,
...
```{r pe_to_nape_sn1_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r pe_to_nape_sn1, message=FALSE, warning=FALSE}
...
```{r peo_to_napeo_sn1_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r peo_to_napeo_sn1, message=FALSE, warning=FALSE}
...
```{r pep_to_napep_sn1_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r pep_to_napep_sn1, message=FALSE, warning=FALSE}
...
```{r pe_to_nape_sn2_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r pe_to_nape_sn2, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PE = PE, PC = PC), 
...
```{r peo_to_napeo_sn2_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r peo_to_napeo_sn2, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(PEO = PEO, PC = PC), 
...
```{r pep_to_napep_sn2_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r pep_to_napep_sn2, message=FALSE, warning=FALSE}
...
```{r nape_to_nae_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r nape_to_nae, message=FALSE, warning=FALSE}
...
```{r napeo_to_nae_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r napeo_to_nae, message=FALSE, warning=FALSE}
...
```{r nape_to_pnae_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r nape_to_pnae, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(NAPE = NAPE), template = template,
...
```{r nape_to_lnape_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r nape_to_lnape, message=FALSE, warning=FALSE}
results <-  create_reaction(substrates = list(NAPE = NAPE), template = template,
...
```{r lnape_to_gpnae_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r lnape_to_gpnae, message=FALSE, warning=FALSE}
...
```{r nae_to_fa_template, message=FALSE, warning=FALSE}
## template for reaction -------------------------------------------------------
template <- list(reaction_name = "",
...
```{r nae_to_fa, message=FALSE, warning=FALSE}
