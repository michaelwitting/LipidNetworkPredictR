...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "LPA",
                                       category = "GP1005",
                                       shorthand = LPAs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PA",
                                       category = "GP1001",
                                       shorthand = PAs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "DG",
                                       category = "GL0201",
                                       shorthand = DGs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "MG",
                                       category = "GL0101",
                                       shorthand = sn2MGs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "TG",
                                       category = "GL0301",
                                       shorthand = TGs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PC",
                                       category = "GP0101",
                                       shorthand = PCs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PE",
                                       category = "GP0201",
                                       shorthand = PEs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PS",
                                       category = "GP0301",
                                       shorthand = PSs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "LPC",
                                       category = "GP0105",
                                       shorthand = sn2LPCs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "LPE",
                                       category = "GP0205",
                                       shorthand = sn2LPEs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "CDPDG",
                                       category = "GP1301",
                                       shorthand = CDPDGs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PI",
                                       category = "GP0601",
                                       shorthand = PIs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PGP",
                                       category = "GP0501",
                                       shorthand = PGPs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "PG",
                                       category = "GP0401",
                                       shorthand = PGs))
```
...
# add lipids to data frame
lipid_df <- bind_rows(lipid_df, tibble(class = "CL",
                                       category = "GP1201",
                                       shorthand = CLs))
